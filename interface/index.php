    ...
    <div class="container">
        <div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
            <button class="how-pos3 hov3 trans-04 js-hide-modal1">
                <img src="<?php echo $productInfo['image']; ?>" alt="CLOSE">
            </button>
                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="<?php echo $productInfo['image']; ?>">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="<?php echo $productInfo['image']; ?>" alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick3" data-thumb="<?php echo $productInfo['image2']; ?>">
                                    <div class="wrap-pic-w pos-relative">
                                ...
                                <div class="item-slick3" data-thumb="<?php echo $productInfo['image3']; ?>">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="<?php echo $productInfo['image3']; ?>" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo $productInfo['image3']; ?>">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
